...
mkvirtualenv: ## create the project environment
	@python3 -m venv "$$WORKON_HOME/p-route-optimization"
	@. "$$WORKON_HOME/p-route-optimization/bin/activate"
	@pip install --upgrade pip setuptools wheel

mkvirtualenv-system: ## create the project environment with system site packages
	@python3 -m venv "$$WORKON_HOME/p-route-optimization" --system-site-packages
	@. "$$WORKON_HOME/p-route-optimization/bin/activate"
	@pip install --upgrade pip setuptools wheel
